...
from train.data.waveforms.generator.generator import (
    WaveformGeneratorOversamplingProjections,
)


class FrequencyDomainCBCGenerator(WaveformGeneratorOversamplingProjections):
    """
