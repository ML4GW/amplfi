...
class WaveformGeneratorDataset(BaseDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.waveform_generator = SineGaussian(self.sample_rate, self.sample_length)
    ...
    def fit_scaler(self, scaler: "ChannelWiseScaler") -> "ChannelWiseScaler":
        ...
        dec, phi, psi = self.sample_extrinsic(self.num_fit_params, device='cpu')
    ...
    def get_val_waveforms(self):
        cross, plus, parameters = self.sample_waveforms(self.val_waveforms_per_device, device='cpu')
        dec, phi, psi = self.sample_extrinsic(self.val_waveforms_per_device, device='cpu')
