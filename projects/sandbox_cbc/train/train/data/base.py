...
class BaseDataset(pl.LightningDataModule):
    ...
    def build_modules(self):
        ...
        self.whitener = Whiten(
            self.hparams.fduration, self.hparams.sample_rate, self.hparams.highpass
        )
    ...
    def val_dataloader(self):
        ...
        kernel_size = int((self.hparams.kernel_length + self.hparams.fduration) * self.hparams.sample_rate)
        ...
        # works on 4D tensors. Add a shift corresponding to current rank (if distributed)
